...
FIRMARE IL FILE CON QUESTO COMANDO: openssl smime -sign -binary -in C:\progetto-solidity\contratto-ricardiano-api-mock\storage\ricardians\ricardian-109.pdf -signer C:\progetto-solidity\contratto-ricardiano-api-mock\storage\ricardians\user-cert.pem -inkey C:\progetto-solidity\contratto-ricardiano-api-mock\storage\ricardians\user-key.pem -certfile C:\progetto-solidity\contratto-ricardiano-api-mock\storage\ricardians\ca-cert.pem -outform DER -out C:\progetto-solidity\contratto-ricardiano-api-mock\storage\ricardians\ricardian-109.pdf.p7m -nodetach
