...
const AUTH_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzU0MDM4OTk3LCJpYXQiOjE3NTQwMzUzOTcsImp0aSI6ImNmODkzNTM5Y2NlYjQyYmRhNjQxNzdjYzAxODUzMmU1IiwidXNlcl9pZCI6MTE0fQ.9V5ff2cykTwkXvJtNCUr5bPgis0Wa04FZSSlxqixyc4";
let DEVICE_ID = "";
const DATASET_IDS = [];
const PK = "0x3c6f9e2d4f72a1b89b8dd934f21cd0e85aa7cb5e9f43d21f6a197b4d23b6e8f1340cf6a6d94cbbeb622cb1a4e017b91b97d8fc70d8d453a35eb5e0cdb1e65708";


async function createDevice() {
  // Uso PK così com’è, con '0x' incluso
  const fullPk = PK;

  try {
    const res = await axios.post(
      `${API_BASE_URL}/device`,
      { pk: fullPk },  // passo pk con '0x'
